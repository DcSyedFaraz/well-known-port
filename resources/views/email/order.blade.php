                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-size:0px;padding:0 25px;word-break:break-word">
                                                <div
                                                    ...
                                                    Hello <strong style="color:#380036"> {{ $order->user->name }} </strong>,<br> Greetings
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr
                                                            ...
                                                            <td
                                                                style="padding:5px;border:1px solid #ecedee;color:#000;letter-spacing:1px;word-spacing:1px;font-size:14px">
                                                                {{ addCurrency($order->invoice->amount) }}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    style="font-family:Poppins,sans-serif;font-size:14px;line-height:20px;text-align:left;color:#555555">
                                                    To confirm your order, please make the payment:
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center" role="presentation"
                                                                style="padding:10px 25px" valign="middle">
                                                                <a rel="notrack"
                                                                    href="{{route('invoice', array('reference' => $order->invoice->ref_no) )}}"
                                                                    style="padding-left:30px;padding-right:30px;padding-bottom:8px;padding-top:8px;width:45%;margin-bottom:10px;background:#5433ff;border-radius:3px;font-size:17px;text-decoration:none;color:#ffffff!important;font-family:Poppins,sans-serif"
                                                                    target="_blank">
                                                                    <img src="https://ci4.googleusercontent.com/proxy/dbxI3e95XBPDqTfWanlQOEehF8ImUXhGbVLiLw_ean0bzcGAZDioz8fys6e1Y5I04wZig0yBu2BYrVc3JiJ2g0OwFC5gsuDmHvbUSDzwmBTlGUT4FJqpCC9X=s0-d-e1-ft#https://www.cvwritings.co.uk/frontend/images/email-icons/card-white.png"
                                                                        alt="Credit Debit" title="Credit Debit"
                                                                        style="display:inline-block;margin-right:5px;width:17px"
                                                                        class="CToWUd">
                                                                        Pay {{ addCurrency($order->invoice->amount) }} with Credit / Debit Card
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
