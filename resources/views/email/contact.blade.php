                            ...
                            <tr>
                                <td colspan="4" valign="top"
                                    ...
                                    <a href="{{route('home')}}" target="_blank">
                                        <img  src="{{ asset('imgs/cheapresumeLogo.png') }}"  alt="{{env('APP_NAME', config('app.name'))}}" style="width:30%;" >
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="border-collapse:collapse;border:0;margin:0;padding:0;color:#555559;font-family:Arial,sans-serif;font-size:16px;line-height:26px">
                                                    <div>
                                                        Greetings from cheapresumewriter.com,
                                                        <br>
                                                        <br>
                                                        ...
                                                        <br>
                                                        <br>Team <strong>cheapresumewriter.com</strong>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
