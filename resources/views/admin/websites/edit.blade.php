    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.websites.update", $website->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $website->slug) }}" required>
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('domain') ? 'is-invalid' : '' }}" type="text" name="domain" id="domain" value="{{ old('domain', $website->domain) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('api_token') ? 'is-invalid' : '' }}" type="int" name="api_token" id="api_token" value="{{ old('api_token', $website->api_token) }}" required>
